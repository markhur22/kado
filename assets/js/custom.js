$(document).ready(function() {
	...
	$(".accordion-body .send-flexi-price input.dis_inpt").attr("disabled", true);	
	$(document).on("click",".picanoption_sec .picanoption", function(e) {
		$('.opt_active').removeClass('opt_active');
	...
	$(document).on("click",".showed_search_filter button", function(e) {
		...
		$('.showed_search_filter input').val('');
		var valuex = $('.showed_search_filter input').val();
			var value = valuex.toLowerCase();
			...
			$(".gt-browse-gift-content.final-brands-card-list .cardlist").filter(function() {
				$(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
				console.log($(this).text().toLowerCase().indexOf(value));
			});
			if ($(".gt-browse-gift-content.final-brands-card-list .cardlist").text().toLowerCase().indexOf(value) > -1){
				$('.noresultfound').hide();
				$('.gt-browse-gift-content.final-brands-card-list .gt-site-pagination').show();
				...
				//console.log('cccccc');
				$('.noresultfound').show();
				$('.gt-browse-gift-content.final-brands-card-list .gt-site-pagination').hide();
				if(value != ''){
					$('.searchicon').hide();
					$('.crossicon').show();
					$('.cross_clear').removeClass('cross_clear');
		...
		$(".gt_bws_gft_content .gt_bws_gft_item").filter(function() {
				$(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
				console.log($(this).text().toLowerCase().indexOf(value));
			});
			if ($(".gt_bws_gft_content .gt_bws_gft_item").text().toLowerCase().indexOf(value) > -1){
				$('.noresultfound').hide();
				//$('.gt-browse-gift-content.final-browse-card-list .gt-site-pagination').show();
	...
	/* $('#inputSearchgifts').change(function(){
		...
		$("ul.gt_browse_gift_list_filter li a").on("click", function() {
			$('ul.gt_browse_gift_list_filter li a').removeClass('active');
		...
		$("ul.gt_brands_gift_list_filter li a").on("click", function() {
			$('ul.gt_brands_gift_list_filter li a').removeClass('active');
			$(this).addClass('active');
			var value = $(this).data('cardname').toLowerCase();
			$(".gt-browse-gift-content.final-brands-card-list .cardlist").filter(function() {
				$(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
		...
		$("ul.gt-sidebar-filter-list.sendgiftcat li a").on("click", function() {
			$('ul.gt-sidebar-filter-list.sendgiftcat li a.active').removeClass('active');
			$(this).addClass('active');
           var value = $(this).data('cardname').toLowerCase();
			$(".gt_bws_gft_content .gt_bws_gft_item").filter(function() {
				$(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
		...
		$("ul.browesgiftcat li a").on("click", function() {
			$('ul.browesgiftcat li a').removeClass('active');
			$(this).addClass('active');
			var valuex = $(this).data('cardname');
			var value = $(this).data('cardname').toLowerCase();
			$(".gt-browse-gift-content.final-browse-card-list .cardlist").filter(function() {
				$(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
				console.log($(this).text().toLowerCase().indexOf(value));
			...
			$('#categoriModal').modal('toggle');
			if(valuex == ''){valuex ="All Gifts"}
			$('a.browse-categori-popup').html(valuex + ' <i class="fa-solid fa-angle-down"></i>');
			
		});
		
		$("ul.browesgiftcatbrands li a").on("click", function() {
			$('ul.browesgiftcatbrands li a').removeClass('active');
			$(this).addClass('active');
			var valuex = $(this).data('cardname');
			var value = $(this).data('cardname').toLowerCase();
			$(".gt-browse-gift-content.final-brands-card-list .cardlist").filter(function() {
		...
		$("input.inputSearchCardsItems").on("keyup", function() {
		...
		$("input.searchgiftmobilesend").on("keyup", function() {
			var value = $(this).val().toLowerCase();
			$(".gt_bws_gft_content .gt_bws_gft_item").filter(function() {
				$(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
				console.log($(this).text().toLowerCase().indexOf(value));
		...
		$(".gt-browse-gift-header-seach input.inputSearchgiftsbrands").on("keyup", function() {
			var value = $(this).val().toLowerCase();
			$(".gt-browse-gift-content.final-brands-card-list .brands_list_outer").filter(function() {
				$(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
				console.log($(this).text().toLowerCase().indexOf(value));
			});
			if ($(".gt-browse-gift-content.final-brands-card-list .brands_list_outer").text().toLowerCase().indexOf(value) > -1){
				$('.noresultfound').hide();
				$('.gt-browse-gift-content.final-brands-card-list .gt-site-pagination').show();
		...
		$("input.searchgiftmobilebrowse").on("keyup", function() {
			var value = $(this).val().toLowerCase();
			$(".gt-browse-gift-content.final-browse-card-list .cardlist").filter(function() {
				$(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
				console.log($(this).text().toLowerCase().indexOf(value));
		...
		$("input.searchgiftmobilebrowsebrand").on("keyup", function() {
			var value = $(this).val().toLowerCase();
			$(".gt-browse-gift-content.final-brands-card-list .cardlist").filter(function() {
				$(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
				console.log($(this).text().toLowerCase().indexOf(value));
	...
	$(document).on('click','.crossicon',function(){
		...
		$('.noresultfound').hide();
		$('.gt-browse-gift-content .gt-site-pagination').show();
		$('.cardlist').show();
	});
 ...
 /*Character Counter */
        function countChar(val) {
            ...
            if (len >= 250) {
                  ...
                  val.value = val.getText().substring(0, 250);
